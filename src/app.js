...
const subscriptionStateRoutes = require('./routes/subscriptionState');
...
class Application {
  ...
  initializeRoutes() {
    ...
    this.app.use(`${basePath}/subscription-state`, securityMiddleware.getRateLimiters().api, subscriptionStateRoutes);
