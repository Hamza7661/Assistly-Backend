...
/**
 * Build HTML for a qualified lead notification sent to the business.
 */
function buildQualifiedLeadNotificationHtml({
  businessName,
  leadType,
  sourceChannel,
  customerName,
...
/**
 * Build HTML for a completed workflow notification with conversation history.
 */
function buildCompletedWorkflowNotificationHtml({
  businessName,
  leadType,
  sourceChannel,
  status,
